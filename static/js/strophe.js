...
*/
	...
	(function(root, factory) {
		if (typeof define === 'function' && define.amd) {
			define('strophe-core', ['strophe-sha1', 'strophe-base64', 'strophe-md5', 'strophe-utils', "strophe-polyfill"],
			function() {
	...
	function(SHA1, Base64, MD5, utils) {
     ...
     */
			namespaceMatch: function(elem) {
				...
				if (!this.ns) {
					...
					var that = this;
					Strophe.forEachChild(elem, null,
					function(elem) {
 ...
 */
		Strophe.Connection = function(service, options) {
			...
			console.log("this.options.mechanisms",this.options.mechanisms)
...
*/
	...
	(function(root, factory) {
		if (typeof define === 'function' && define.amd) {
			define('strophe-bosh', ['strophe-core'],
			function(core) {
...
*/
	...
	(function(root, factory) {
		if (typeof define === 'function' && define.amd) {
			define('strophe-websocket', ['strophe-core'],
			function(core) {
				return factory(core.Strophe, core.$build);
			});
		} else {
 ...
 */
	...
	(function(root) {
		if (typeof define === 'function' && define.amd) {
			define("strophe", ["strophe-core", "strophe-bosh", "strophe-websocket"],
			function(wrapper) {
				return wrapper;
			});
		}
